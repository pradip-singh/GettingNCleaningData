...
1. Merges the training and the test sets to create one data set. **Complted** 
...
```
## [1] "C:/GettingNCleaningData/week_3/Project"
```
...
```
Unzip the file. **This was already done on 2014-08-22; save time and don't evaluate again.**
